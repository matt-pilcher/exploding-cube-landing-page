...
/**
 * This component renders a <canvas> element on the landing page. All code related to rendering
 * the 3D environment lives here.
 **/ 
...
export default function Home() {
  ...
  return (
    <main className="container grid homepage-layout py-2 m-auto md:grid-cols-2 h-full">
      ...
      <aside className="grid items-center overflow-hidden">
        <div className="canvas-container px-2 overflow-hidden cursor-grab relative">
          {/* 3D Cube */}
